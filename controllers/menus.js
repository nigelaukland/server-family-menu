...
exports.postEditMenu = (req, res, next) => {
  ...
  const name = req.body.name;
  const startDate = req.body.startDate;
  const dayMenu1 = (req.body.dayMenu1 === '') ? undefined : mongoose.Types.ObjectId(req.body.dayMenu1);
  const dayMenu2 = (req.body.dayMenu2 === '') ? undefined : mongoose.Types.ObjectId(req.body.dayMenu2);
